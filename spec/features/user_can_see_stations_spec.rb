...
# You will be using this documentation:
...
# And the stations should only be public,
# and not private, planned or temporarily unavailable.
# And for each of the stations I should see
# Name, Address, Fuel Types, Distance, and Access Times

describe 'as a user visiting root' do
  it 'shows total results' do
    ...
    expect(page).to have_content("90 locations found")
  end
end
